    ...
    <>
      ...
      >
        ...
        >
          ...
          <p
            className={cn(
              'font-mono text-[10px] text-accent lg:text-accent lg:text-xs justify-center capitalize flex flex-wrap gap-2 lg:gap-x-2 items-center lg:justify-end mx-auto',
              align === 'left' && 'lg:justify-start'
            )}
          >
            {tags.map((tag) => (
              <span
                className="border rounded-lg p-1 bg-accent text-white"
                key={tag.replaceAll(' ', '')}
              >
                {tag}
              </span>
